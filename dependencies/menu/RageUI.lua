		...
		if Enabled == true then
			if RageUI.CurrentMenu ~= nil then
				if RageUI.CurrentMenu() then
					...
					if Config.EnablePicture then
						RenderSprite("krz_generateTextures", "banner", RageUI.CurrentMenu.X, RageUI.CurrentMenu.Y, RageUI.Settings.Items.Title.Background.Width + RageUI.CurrentMenu.WidthOffset, RageUI.Settings.Items.Title.Background.Height, 0, 255, 255, 255, 255)
					else
