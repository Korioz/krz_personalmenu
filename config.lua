...
-- BANNER --
Config.EnablePicture = true -- enable if you're using Config.PictureURL
Config.PictureURL = "https://upload.wikimedia.org/wikipedia/commons/4/43/Ambersweet_oranges.jpg" -- recommended resolution: 512x128px
